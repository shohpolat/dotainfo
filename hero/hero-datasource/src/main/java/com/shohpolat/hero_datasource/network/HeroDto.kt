...
import com.shohpolat.hero_datasource.network.EndPoints.BASE_URL
import com.shohpolat.hero_domain.Hero
import com.shohpolat.hero_domain.getHeroAttackType
import com.shohpolat.hero_domain.getHeroAttrFromAbbrValue
import com.shohpolat.hero_domain.getHeroRole
...
fun HeroDto.toHero(): Hero {
    return Hero(
        ...
        primaryAttribute = getHeroAttrFromAbbrValue(primaryAttribute),
