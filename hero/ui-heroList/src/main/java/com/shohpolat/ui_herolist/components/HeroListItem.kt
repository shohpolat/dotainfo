...
import com.shohpolat.ui_herolist.ui.test.TAG_HERO_NAME
import com.shohpolat.ui_herolist.ui.test.TAG_HERO_PRIMARY_ATTRIBUTE
import com.shohpolat.ui_herolist.*
...
fun HeroListItem(
    ...
    Surface(
        ...
        Row(
            ...
            val painter = rememberImagePainter(hero.img,imageLoader = imageLoader, builder ={
            })
