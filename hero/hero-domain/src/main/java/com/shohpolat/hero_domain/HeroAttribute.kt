...
fun getHeroAttrFromUiValue(uiValue: String): HeroAttribute {
    return when(uiValue) {
        HeroAttribute.Strength.uiValue -> HeroAttribute.Strength
        HeroAttribute.Agility.uiValue -> HeroAttribute.Agility
        HeroAttribute.Intelligence.uiValue -> HeroAttribute.Intelligence
        else -> HeroAttribute.Unknown
    }
}

fun getHeroAttrFromAbbrValue(abbreviation: String): HeroAttribute {
    return when(abbreviation) {
        HeroAttribute.Strength.abbreviation -> HeroAttribute.Strength
        HeroAttribute.Agility.abbreviation -> HeroAttribute.Agility
        HeroAttribute.Intelligence.abbreviation -> HeroAttribute.Intelligence
        else -> HeroAttribute.Unknown
    }
}
